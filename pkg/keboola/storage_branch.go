...
func (a *API) ListBranchesRequest() request.APIRequest[*[]*Branch] {
...
func (a *API) GetDefaultBranchRequest() request.APIRequest[*Branch] {
...
func (a *API) CreateBranchRequest(branch *Branch) request.APIRequest[*Branch] {
	req := a.
...
func (a *API) CreateBranchAsyncRequest(branch *Branch) request.APIRequest[*StorageJob] {
	// ID is autogenerated
	if branch.ID != 0 {
...
func (a *API) UpdateBranchRequest(branch *Branch, changedFields []string) request.APIRequest[*Branch] {
	// ID is required
	if branch.ID == 0 {
...
func (a *API) DeleteBranchRequest(key BranchKey) request.APIRequest[request.NoResult] {
	req := a.
...
func (a *API) DeleteBranchAsyncRequest(key BranchKey) request.APIRequest[*StorageJob] {
	result := &StorageJob{}
	req := a.
		newRequest(StorageAPI).
		WithResult(result).
...
func (a *API) ListBranchMetadataRequest(key BranchKey) request.APIRequest[*MetadataDetails] {
...
func (a *API) AppendBranchMetadataRequest(key BranchKey, metadata Metadata) request.APIRequest[request.NoResult] {
...
func (a *API) DeleteBranchMetadataRequest(branch BranchKey, metaID string) request.APIRequest[request.NoResult] {
	req := a.
		newRequest(StorageAPI).
